...
public class MUI extends javax.swing.JFrame implements AcquaintanceIterator {
    ...
    private static ArrayList<Acquaintances> sportsFriends;
    private static ArrayList<Acquaintances> neighbors;
    ...
    private MUI() {
        initComponents();
        String[] columnNames = {"S.No", "Name", "Mobile", " Email", "Relation", "Status"};
        ...
        acquaintances.add(sportsFriends);
        acquaintances.add(neighbors);
    ...
    public void setDescription() {
        ...
        if (addOrEditFlag) {
            ...
            switch (categoryIndex) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    SportsFriends sF = (SportsFriends) e;
                    one.setText(sF.getPlaceToGo());
                    two.setText(sF.getTypeOfActivities());
                    three.setText(sF.getDate());
                    break;
                case 5:
                    Neighbors nB = (Neighbors) e;
                    one.setText(nB.getRace());
                    two.setText(nB.getCommonInterest());
                    break;
                default:
                    break;
            }
        ...
        switch (categoryIndex) {
            ...
            case 4:
                ...
                two.setVisible(true);
                three.setVisible(true);
                jLabel7.setText("Place to go: ");
                jLabel8.setText("Type of activities: ");
                jLabel9.setText("<html>Date:<br>(dd/mm/yyyy)</html> ");
                Operation_Menu.setBorder(javax.swing.BorderFactory.createTitledBorder(null, op + " Sports Friends Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("DialogInput", 1, 16)));
                jLabel7.setVisible(true);
                jLabel8.setVisible(true);
                jLabel9.setVisible(true);
                jScrollPane4.setVisible(true);
            ...
            case 5:
                ...
                jLabel8.setText("Common Interest: ");
                jLabel9.setText("");
                Operation_Menu.setBorder(javax.swing.BorderFactory.createTitledBorder(null, op + " Neighbors Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("DialogInput", 1, 16)));
                jLabel7.setVisible(true);
                jLabel8.setVisible(true);
                jLabel9.setVisible(false);
                jScrollPane4.setVisible(true);
    ...
    public final void setUpTableData() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            data[4] = list.get(i).tryToBestfriend();
            data[5] = list.get(i).getStatus();
    ...
    private void initComponents() {
        ...
        Categories.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Personal Friends", "Relatives", "Professional Friends", "Casual Acquaintances", "Sports Friends", "Neighbors", " " };
    ...
    public void runn() {
        ...
        j = 0;
        for (int i = 0; i < acquaintances.get(4).size(); i++) {
            if (acquaintances.get(4).get(i).getName().matches(searchString)) {
                j++;
                SportsFriends sF = (SportsFriends) acquaintances.get(4).get(i);
                if (j == 1) {
                    s = s.concat("<br>IV. Sports Friends<br>");
                }
                s = s.concat(j + ". Name: " + sF.getName() + "<br>");
                s = s.concat("Mobile No: " + sF.getMobileNo() + "<br>");
                s = s.concat("Email: " + sF.getEmail() + "<br>");
                s = s.concat("Status: " + sF.getStatus() + "<br>");
                s = s.concat("Place to go: " + sF.getPlaceToGo() + "<br>");
                s = s.concat("Type of activities: " + sF.getTypeOfActivities() + "<br>");
                s = s.concat("Date: " + sF.getDate() + "<br>");
            }
        }
        j = 0;
        for (int i = 0; i < acquaintances.get(5).size(); i++) {
            if (acquaintances.get(5).get(i).getName().matches(searchString)) {
                j++;
                Neighbors nB = (Neighbors) acquaintances.get(5).get(i);
                if (j == 1) {
                    s = s.concat("<br>IV. Neighbors<br>");
                }
                s = s.concat(j + ". Name: " + nB.getName() + "<br>");
                s = s.concat("Mobile No: " + nB.getMobileNo() + "<br>");
                s = s.concat("Email: " +nB.getEmail() + "<br>");
                s = s.concat("Race: " + nB.getRace() + "<br>");
                s = s.concat("Commmon Interest: " + nB.getCommonInterest() + "<br>");
            }
        }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        InContact inContact = new InContact();
        ...
        switch (categoryIndex) {
            case 0: //perF
                ...
                personalF.setStatus(new InContact().relationStatus(context));
                System.out.println(context.getStatus());
                personalF.setBestfriendAbility(new CanBestfriend());
                System.out.println(personalF.tryToBestfriend());
                if (addOrEditFlag) {
            ...
            case 1: //rel
                ...
                rel.setBDate(One);
                rel.setLDate(Two);
                rel.setStatus(new InContact().relationStatus(context));
                System.out.println(rel.getStatus());
                rel.setBestfriendAbility(new CanBestfriend());
                System.out.println(rel.tryToBestfriend());
                if (addOrEditFlag) {
            ...
            case 2: //proF
                ...
                proF.setStatus(new InContact().relationStatus(context));
                System.out.println(proF.getStatus());
                proF.setBestfriendAbility(new CantBestfriend());
                System.out.println(proF.tryToBestfriend());
                if (addOrEditFlag) {
            ...
            case 3: //ca
                ...
                ca.setStatus(new LostContact().relationStatus(context));
                System.out.println(ca.getStatus());
                ca.setBestfriendAbility(new CantBestfriend());
                System.out.println(ca.tryToBestfriend());
                if (addOrEditFlag) {
            ...
            case 4:
                ...
                SportsFriends sF;
                if (addOrEditFlag) {
                    sF = (SportsFriends) Acquaintancesfactory.createAcquaintance("SportsFriends");
                } else {
                    sF = (SportsFriends) acquaintances.get(categoryIndex).get(ArrayListIndex);
                }
                sF.setName(Name);
                sF.setMobileNo(Mobile);
                sF.setEmail(Email);
                sF.setPlaceToGo(One);
                sF.setTypeOfActivities(Two);
                sF.setDate(Three);
                sF.setStatus(new LostContact().relationStatus(context));
                System.out.println(sF.getStatus());
                sF.setBestfriendAbility(new CantBestfriend());
                System.out.println(sF.tryToBestfriend());
                if (addOrEditFlag) {
                    acquaintances.get(categoryIndex).add(sF);
                }
                break;
            case 5:
                One = one.getText();
                ...
                Neighbors nB;
                if (addOrEditFlag) {
                    nB = (Neighbors) Acquaintancesfactory.createAcquaintance("Neighbors");
                } else {
                    nB = (Neighbors) acquaintances.get(categoryIndex).get(ArrayListIndex);
                }
                nB.setName(Name);
                nB.setMobileNo(Mobile);
                nB.setEmail(Email);
                nB.setRace(One);
                nB.setCommonInterest(Two);
                nB.setStatus(new InContact().relationStatus(context));
                System.out.println(nB.getStatus());
                nB.setBestfriendAbility(new CanBestfriend());
                System.out.println(nB.tryToBestfriend());
                if (addOrEditFlag) {
                    acquaintances.get(categoryIndex).add(nB);
                }
                break;
            default:
                break;
